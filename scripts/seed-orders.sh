...
grpcurl -d '{"orderId":"2"}' -plaintext localhost:10001 fulfillment.Fulfillment.GetOrderStatusById
grpcurl -d '{"orderId":"3"}' -plaintext localhost:10001 fulfillment.Fulfillment.GetOrderStatusById
sleep 1
grpcurl -d '{"orderId":"4"}' -plaintext localhost:10001 fulfillment.Fulfillment.GetOrderStatusById
grpcurl -d '{"orderId":"5"}' -plaintext localhost:10001 fulfillment.Fulfillment.GetOrderStatusById
sleep 5
